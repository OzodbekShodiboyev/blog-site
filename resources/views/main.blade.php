                ...
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2">
                        ...
                        <li class="nav-item ">
                            ...
                            @auth
                                <a href="{{ url('/dashboard') }}" class="nav-link text-body small nav-item border-right border-secondary">
                                    {{ Auth::user()->name }}
                                </a>
                                <li class="nav-item border-right border-secondary">
                                    <form action="{{ route('logout') }}" method="post">
                                        @csrf
                                        <button style="background: none; outline: none; border: none;" type="submit" class="nav-link text-body small ">
                                            Log out
                                        </button>
                                    </form>
                                </li>
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-3">
                            <a href=""><img class="img-fluid w-100" src="assets/img/ads-728x90.png"
                                    alt=""></a>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid" src="assets/img/news-800x500-2.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <!-- Ads End -->
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="assets/img/news-110x110-1.jpg"
                                alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="assets/img/news-110x110-2.jpg"
                                alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="assets/img/news-110x110-3.jpg"
                                alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="assets/img/news-110x110-4.jpg"
                                alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="assets/img/news-110x110-5.jpg"
                                alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="assets/img/news-110x110-1.jpg"
